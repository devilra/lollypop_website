...
const ProcessHero = () => {
  return (
    <section>
      <div className="md:pl-44 md:pt-16">
        ...
        <div className="flex justify-start items-start ">
          ...
          <h1 className="md:mt-5 md:w-[700px] text-3xl py-5 md:py-0 font-extrabold text-[#221429] md:text-6xl">
            A Process Designed
            <br />
            Around Your User best for your business
            <br />
            <span className="text-[#221429] text-lg md:text-xl font-light md:w-[850px] inline-block md:my-7 my-3">
